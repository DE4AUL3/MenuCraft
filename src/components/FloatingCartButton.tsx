...
export default function FloatingCartButton() {
  ...
  return (
    ...
    >
      ...
      {/* Основная кнопка */}
      <div className="relative text-white p-4 rounded-full shadow-xl hover:shadow-2xl transition-all duration-500 transform group-hover:scale-110 group-active:scale-95" style={{ 
