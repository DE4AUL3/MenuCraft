...
export default function FloatingRestaurantButton() {
  ...
  const switchRestaurant = () => {
    // Переключаемся на Han Tagam
    window.location.href = 'https://hantagam.com/menu';
  };
  ...
  return (
    <button
      ...
      aria-label="Переключить на Han Tagam"
      style={{ boxShadow: '0 25px 50px -12px rgba(220, 38, 38, 0.6)' }}
    >
      {/* Иконка */}
