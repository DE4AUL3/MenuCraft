          ...
          <div className="flex items-center justify-between h-14 sm:h-16">
            ...
            <div className="flex items-center gap-2 sm:gap-3 min-w-0 flex-1">
              ...
              <div className="flex-shrink-0">
                {currentRestaurant === 'panda-burger' || currentRestaurant === '1' ? (
                  // Логотип Panda Burger
                  <div className="w-10 h-10 sm:w-12 sm:h-12 bg-[#1a1a1d] rounded-xl flex items-center justify-center shadow-md hover:shadow-lg transition-all duration-300 hover:scale-105 ring-2 ring-[#d4af37]/20">
                    <img 
                      src="/panda_logo.png" 
                      alt="Panda Burger"
